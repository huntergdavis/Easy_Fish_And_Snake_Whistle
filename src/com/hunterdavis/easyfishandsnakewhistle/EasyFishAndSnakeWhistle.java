package com.hunterdavis.easyfishandsnakewhistle;
...
public class EasyFishAndSnakeWhistle extends Activity { 
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		OnClickListener dogTwoListener = new OnClickListener() {
			public void onClick(View v) {
				playFrequency(v.getContext(), 500);
			}
		};
		...
		OnClickListener dogThreeListener = new OnClickListener() {
			public void onClick(View v) {
				playFrequency(v.getContext(), 1500);
			}
		};
